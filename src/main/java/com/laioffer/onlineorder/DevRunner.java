...
public class DevRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        List<OrderItemEntity> newOrderItems = List.of(
                new OrderItemEntity(null, 1L, 1L, 4.89, 1),
                new OrderItemEntity(null, 3L, 1L, 7.99, 1),
                new OrderItemEntity(null, 5L, 1L, 6.39, 1),
                new OrderItemEntity(null, 7L, 1L, 6.09, 1),
                new OrderItemEntity(null, 9L, 1L, 12.19, 1),
                new OrderItemEntity(null, 1L, 2L, 4.89, 1),
                new OrderItemEntity(null, 2L, 2L, 10.59, 1),
                new OrderItemEntity(null, 3L, 2L, 7.99, 1),
                new OrderItemEntity(null, 4L, 2L, 3.09, 1),
                new OrderItemEntity(null, 5L, 2L, 6.39, 1)
        );
